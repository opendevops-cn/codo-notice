...
const (
	User_ListUser_FullMethodName = "/ops.codo.notice.user.v1.User/ListUser"
	User_GetUser_FullMethodName  = "/ops.codo.notice.user.v1.User/GetUser"
)
...
func (c *userClient) GetUser(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*UserDTO, error) {
	out := new(UserDTO)
...
func (UnimplementedUserServer) GetUser(context.Context, *GetUserRequest) (*UserDTO, error) {
...
var User_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ops.codo.notice.user.v1.User",
	...
	Metadata: "pb/user/user.v1.proto",
}
