...
use `codo-notice`;
INSERT INTO `codo_template` (`id`,`created_at`,`updated_at`,`deleted_at`,`created_by`,`updated_by`,`name`,`type`,`use`,`default`,`content`) VALUES (1,'2022-07-29 18:00:00.000','2022-07-29 19:59:59.000',NULL,'admin(管理员)','admin(管理员)','阿里云短信默认模版','alydx','default','yes','{{.title}}, {{.description}}');
INSERT INTO `codo_template` (`id`,`created_at`,`updated_at`,`deleted_at`,`created_by`,`updated_by`,`name`,`type`,`use`,`default`,`content`) VALUES (2,'2022-07-29 18:00:00.000','2022-07-29 19:59:58.000',NULL,'admin(管理员)','admin(管理员)','阿里云电话默认模版','alydh','default','yes','{{.title}}, {{.description}}');
INSERT INTO `codo_template` (`id`,`created_at`,`updated_at`,`deleted_at`,`created_by`,`updated_by`,`name`,`type`,`use`,`default`,`content`) VALUES (3,'2022-07-29 18:00:00.000','2022-07-29 19:59:57.000',NULL,'admin(管理员)','admin(管理员)','腾讯云短信默认模版','txdx','default','yes','{\"msg\":\"{{.message}}\"}');
INSERT INTO `codo_template` (`id`,`created_at`,`updated_at`,`deleted_at`,`created_by`,`updated_by`,`name`,`type`,`use`,`default`,`content`) VALUES (4,'2022-07-29 18:00:00.000','2022-07-29 19:59:56.000',NULL,'admin(管理员)','admin(管理员)','腾讯云电话默认模版','txdh','default','yes','{\"msg\":\"{{.message}}\"}');
INSERT INTO `codo_template` (`id`,`created_at`,`updated_at`,`deleted_at`,`created_by`,`updated_by`,`name`,`type`,`use`,`default`,`content`)
...
INSERT INTO `codo_template` (`id`,`created_at`,`updated_at`,`deleted_at`,`created_by`,`updated_by`,`name`,`type`,`use`,`default`,`content`) VALUES (12,'2022-07-29 18:00:00.000','2022-07-29 19:59:48.000',NULL,'admin(管理员)','admin(管理员)','Webhook默认模版','webhook','default','yes','{\"message\":\"{{.message}}\"}');
INSERT INTO `codo_template` (`id`,`created_at`,`updated_at`,`deleted_at`,`created_by`,`updated_by`,`name`,`type`,`use`,`default`,`content`)
